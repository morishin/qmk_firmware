...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_GRAVE, KC_UP, KC_ESC, \
    MO(1), KC_LCTL,  KC_LALT,  LGUI_T(KC_LANG2),      KC_SPC,    RSFT_T(KC_SPC),  RGUI_T(KC_LANG1), KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  [1] = LAYOUT( \
